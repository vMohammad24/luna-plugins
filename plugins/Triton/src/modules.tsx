...
export const coverTheme = TritonModule.fromName("CoverTheme", {
	author: Nick,
	desc: "Theme based on the current playing song. Also adds CSS variables to be used in custom themes",
});
export const discordRPC = TritonModule.fromName("DiscordRPC", {
	author: Inrixia,
	desc: "Show off what you are listening to in your Discord status",
});
export const realMax = TritonModule.fromName("RealMAX", {
	author: Inrixia,
	desc: (
		<>
...
export const listenBrainz = TritonModule.fromName(
	"ListenBrainz",
	{
		author: Inrixia,
		desc: (
...
export const lastFM = TritonModule.fromName(
	"LastFM",
	{
		author: Inrixia,
		desc: (
...
export const shazam = TritonModule.fromName(
	"Shazam",
	{
		author: Inrixia,
		desc: (
...
export const nativeFullscreen = TritonModule.fromName(
	"NativeFullscreen",
	{
		author: Inrixia,
...
export const volumeScroll = TritonModule.fromName("VolumeScroll", {
	author: Nick,
	desc: (
		<>
